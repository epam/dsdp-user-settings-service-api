...
public class SettingsController {
  ...
  public ResponseEntity<Void> activateChannel(
      ...
      @Parameter(hidden = true) @RequestHeader("X-Access-Token") String accessToken) {
    log.info("Channel activation is called");
  ...
  @Operation(
      ...
      parameters = {
        ...
        @Parameter(
            ...
            description = "User language to generate correct verification message",
            schema = @Schema(type = "string"))
      },
      requestBody =
          @io.swagger.v3.oas.annotations.parameters.RequestBody(
              ...
              content =
                  @Content(
                      ...
                      schema = @Schema(implementation = VerificationInputDto.class),
                      examples = {
                        @ExampleObject(
                            value =
                                """
      ...
      responses = {
        @ApiResponse(
            ...
            content =
                @Content(
                    schema = @Schema(implementation = VerificationCodeExpirationDto.class),
                    examples =
                        @ExampleObject(
                            value =
                                """
  ...
  public ResponseEntity<VerificationCodeExpirationDto> verifyChannelAddress(
      ...
      @Parameter(hidden = true) @RequestHeader("X-Access-Token") String accessToken,
      @RequestHeader(value = HttpHeaders.ACCEPT_LANGUAGE, required = false) String userLanguage) {
    log.info("Channel verification is called");
    var response = channelVerificationService.sendVerificationCode(channel, input, accessToken, userLanguage);
