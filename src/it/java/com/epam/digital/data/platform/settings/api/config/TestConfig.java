...
public class TestConfig {
  ...
  @Bean
  public NotificationSettingsService testNotificationSettingsService() {
    return Mockito.mock(NotificationSettingsService.class);
  }

  @Bean
  public HandlerInterceptor testHandlerInterceptor() {
    return Mockito.mock(HandlerInterceptor.class);
  }

  @Bean
  public KafkaProperties testKafkaProperties() {
    return Mockito.mock(KafkaProperties.class);
  }
