...
class NotificationServiceTest {
  ...
  void shouldSendCorrectEmailNotificationDto() {
    ...
    notificationService.sendNotification(
        EMAIL_CHANNEL, EMAIL_ADDRESS, USER_ID, OTP_CODE, Recipient.RecipientRealm.OFFICER, USER_LANGUAGE);
    ...
    assertThat(notificationDto.getNotification().getTitle()).isNull();
    assertThat(notificationDto.getNotification().isIgnoreChannelPreferences()).isTrue();
    assertThat(notificationDto.getNotification().getLanguage()).isEqualTo(USER_LANGUAGE);
  ...
  void shouldSendCorrectDiiaNotificationDto() {
    ...
    notificationService.sendNotification(
        DIIA_CHANNEL, DIIA_ADDRESS, USER_ID, OTP_CODE, Recipient.RecipientRealm.OFFICER, USER_LANGUAGE);
