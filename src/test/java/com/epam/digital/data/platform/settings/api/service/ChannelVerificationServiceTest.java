...
class ChannelVerificationServiceTest {
  ...
  void shouldSendVerificationCode() {
    ...
    var response = channelVerificationService.sendVerificationCode(EMAIL_CHANNEL,
        inputDto, VALID_ACCESS_TOKEN, USER_LANGUAGE);
    ...
    verify(notificationService).sendNotification(EMAIL_CHANNEL, VALID_EMAIL_ADDRESS,
        USER_NAME, VALID_OTP_CODE, Recipient.RecipientRealm.CITIZEN, USER_LANGUAGE);
  }
    ...
    Assertions.assertThatThrownBy(
            () ->
                channelVerificationService.sendVerificationCode(
                    EMAIL_CHANNEL, null, VALID_ACCESS_TOKEN, USER_LANGUAGE))
